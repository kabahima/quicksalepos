...
if not DEBUG and SECRET_KEY.startswith("django-insecure-"):
    raise ValueError("DJANGO_SECRET_KEY must be set to a secure value when DEBUG=False")
...
MIDDLEWARE = [
    ...
    "bookkeeping.middleware.APITrailingSlashMiddleware",
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "receipts@quicksale.local")
